...
const Info = ({ room }) => {
  ...
  return (
    <span className="p-4 pt-0 grid md:mt-0 mt-4">
      ...
      <h1 className={txt}>
        <BsCalendar2CheckFill className="inline mr-1" />
        <span className="rale font-normal text-gray-400 mr-2 whitespace-pre-wrap">updated:</span>
      ...
      <h1 className={highlight}>
        <IoIosBed className="inline mr-1" />
        <span className="rale font-normal text-gray-400 mr-2 whitespace-pre-wrap">description:</span>

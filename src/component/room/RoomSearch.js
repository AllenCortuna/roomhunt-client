...
const RoomSearch = () => {
  ...
  const empty = (
    <span className="mx-auto mt-14 md:mt-20 w-[21rem] p-10 ">
      <img src={noRoom} alt="empty" className="drop-shadow-sm mx-auto mb-8 " />
      <h1 className="text-gray-500 text-center text-sm mb-5" >No rooms available according to your search</h1>
